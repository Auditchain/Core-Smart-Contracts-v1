...
module.exports = async function (deployer, network, accounts) { // eslint-disable-line..
  ...
  members.addUser(enterprise1, "Datasubscriber 2", 2, { from: admin });
  console.log('members.addUser(enterprise1, "Datasubscriber 2", 2, { from: admin });');

  members.addUser(enterprise2, "Datasubscriber 3", 2, { from: admin });
  console.log('members.addUser(enterprise2, "Datasubscriber 3", 2, { from: admin });');
