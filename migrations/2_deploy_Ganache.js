...
module.exports = async function (deployer, network, accounts) { // eslint-disable-line..
  ...
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator1, gas: 800000 });
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator2, gas: 800000 });
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator3, gas: 800000 });
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator4, gas: 800000 });
  ...
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator1, gas: 800000 });
  await cohort.validate(documentHash, validationInitTime, 2, "", documentHash, { from: validator2, gas: 800000 });
  ...
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator1, gas: 800000 });
  await cohort.validate(documentHash, validationInitTime, 2, "", documentHash, { from: validator2, gas: 800000 });
  result = await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator3, gas: 800000 });
  ...
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator1, gas: 900000 });
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator2, gas: 900000 });
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator3, gas: 900000 });
  await cohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator4, gas: 900000 });
  ...
  await noCohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator1, gas: 800000 });
  await noCohort.validate(documentHash, validationInitTime, 2, "", documentHash, { from: validator2, gas: 800000 });
  let resultVal = await noCohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator3, gas: 800000 });
  await noCohort.validate(documentHash, validationInitTime, 1, "", documentHash, { from: validator4, gas: 800000 });
