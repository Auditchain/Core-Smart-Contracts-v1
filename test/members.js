...
contract("Member contract", (accounts) => {
    ...
    //         await members.addValidatorUser(validator2, "Validators 2", { from: admin });
    //         await members.addValidatorUser(validator3, "Validators 3", { from: admin });
    //         await members.addValidatorUser(validator4, "Validators 4", { from: admin });
    ...
    //         await cohortContract.methods.grantRole(CONTROLLER_ROLE, members.address).send({ from: admin });
    ...
    //         await members.updateDailyEarningsTransferFunds(validatorsToSend, amountsToSend, cohortAddress, { from: admin, gas: 200000 });
    ...
    //         let result = await members.updateDailyEarningsTransferFunds(validatorsToSend, amountsToSend, cohortAddress, { from: admin, gas: 200000 });
